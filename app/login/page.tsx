    ...
    async function load() {
      try {
        ...
        logs.forEach((log: any) => {
          const name = Array.isArray(log.agents)
            ? log.agents[0]?.name
            : log.agents?.name
    ...
    >
      ...
      <div
        style={{
          ...
          height: 600,
          borderRadius: '50%',
          background: 'radial-gradient(circle,#0f172a,transparent 70%)',
          bottom: -150,
          right: -100,
      ...
      >
        <div style={{ paddingRight: 40, animation: 'fadeUp 0.6s ease forwards' }}>
          ...
          >
            Plataforma centralizada de agentes de IA para os especialistas do
            SENAI Bahia — tudo num só lugar.
          </p>
        ...
        <div style={{ padding: '0 20px', animation: 'fadeUp 0.7s ease 0.1s both' }}>
          ...
          >
            ...
            >
              Acesse os agentes de IA dos cursos técnicos do SENAI Bahia
              diretamente, sem precisar de login.
            </div>
        ...
        >
          ...
          >
            ...
            >
              <span style={{ color: '#4ade80' }}>✓</span> supabase{' '}
              <span style={{ color: 'rgba(255,255,255,0.2)' }}>conectado</span>
              <br />
              <span style={{ color: '#4ade80' }}>✓</span> openai &nbsp;&nbsp;
              <span style={{ color: 'rgba(255,255,255,0.2)' }}>operacional</span>
              <br />
              <span style={{ color: '#4ade80' }}>✓</span> agents &nbsp;&nbsp;
              <span style={{ color: 'rgba(255,255,255,0.2)' }}>ativos</span>
              <span
                style={{
