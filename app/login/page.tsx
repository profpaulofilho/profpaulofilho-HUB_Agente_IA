          ...
          <div style={{background:'rgba(255,255,255,0.03)',border:'1px solid rgba(255,255,255,0.08)',borderRadius:16,padding:'18px 20px'}}>
            <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',marginBottom:16}}>
              <div>
                ...
                <div style={{fontSize:10,color:'rgba(255,255,255,0.3)',marginTop:2}}>Acessos totais</div>
              </div>
              <span style={{fontSize:10,color:'rgba(255,255,255,0.2)',background:'rgba(255,255,255,0.05)',borderRadius:20,padding:'3px 8px'}}>Geral</span>
            </div>
